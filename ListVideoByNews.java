...
public class ListVideoByNews extends HttpServlet {
	Connection con;
	DbUtil db=new DbUtil();
	public ListVideoByNews(){
...
public void doGet(HttpServletRequest request,HttpServletResponse response){
	...
	try {
		...
		ResultSet rs=st.executeQuery("select vname,video_url from video_table where cat_id=1");
		...
		while(rs.next()){
			...
			out.print("<li><a href=\""+strs[6]+"/"+strs[7]+"\"><button style=\"width:100px;height:90px;padding:1%;\"><img src=\"videoimg2.png\" height=\"50px\" width=\"80px\"><br>"+rs.getString(1)+"</button></a></li>");
		}
		out.print("<ul>");
